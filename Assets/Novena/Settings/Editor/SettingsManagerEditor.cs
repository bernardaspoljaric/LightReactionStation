...
namespace Novena.Settings.Editor
{
  ...
  public class SettingsManagerEditor : UnityEditor.Editor
  {
    ...
    void AddSettingItem()
    {
      ...
      settingData.Name = FieldName;
      settingData.Type = FieldType.ToString();
      settingData.Value = FieldValue;
      settingData.Description = FieldDescription;

      _settingsManager.AddNewItem(settingData);
    }
